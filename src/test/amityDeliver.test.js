...
const possibleRoute = require('../util/possibleRoute');
const lowestCostRoute = require('../util/lowestCostRoute');
...
test('Case 2-1', () => {
  expect(possibleRoute('AB1,AC4,AD10,BE3,CD4,CF2,DE1,EB3,EA2,FD1','E','D',4)).toBe(4);
});

test('Case 2-2', () => {
  expect(possibleRoute('AB1,AC4,AD10,BE3,CD4,CF2,DE1,EB3,EA2,FD1','E','E',null)).toBe(11);
});
